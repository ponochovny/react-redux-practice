								...
								{persons.map((el) => (
									<div className='person' key={el.id}>
										<div
											...
											style={{
												backgroundImage: `url(${'https://images.unsplash.com/photo-1499996860823-5214fcc65f8f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=766&q=80'})`,
											}}
										></div>
